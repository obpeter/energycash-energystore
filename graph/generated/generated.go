...
type ComplexityRoot struct {
	...
	Query struct {
		Eeg            func(childComplexity int, name string, year int, month *int, function *string) int
...
type QueryResolver interface {
	...
	Eeg(ctx context.Context, name string, year int, month *int, function *string) (*model.EegEnergy, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.eeg":
		if e.complexity.Query.Eeg == nil {
			break
		}

		args, err := ec.field_Query_eeg_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.Eeg(childComplexity, args["name"].(string), args["year"].(int), args["month"].(*int), args["function"].(*string)), true
...
type Query {
  ...
  eeg(name: String!, year: Int!, month: Int, function: String): EegEnergy!
...
func (ec *executionContext) field_Query_eeg_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["name"]; ok {
...
func (ec *executionContext) _Query_eeg(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_eeg(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Eeg(rctx, fc.Args["name"].(string), fc.Args["year"].(int), fc.Args["month"].(*int), fc.Args["function"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_eeg(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_eeg_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
